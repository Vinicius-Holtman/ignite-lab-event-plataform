        ...
        <div className="flex items-start gap-16">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              <img className="h-16 w-16 rounded-full border-2 border-blue-500" src="https://github.com/Vinicius-Holtman.png" alt="Avatar GitHub" />

              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Vinicius Holtman</strong>
